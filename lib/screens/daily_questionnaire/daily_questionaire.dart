...
class DailyQuestionnaire extends StatefulWidget {
  const DailyQuestionnaire({Key? key}) : super(key: key);

  @override
  State<DailyQuestionnaire> createState() => _DailyQuestionnaireState();
}

class _DailyQuestionnaireState extends State<DailyQuestionnaire> {
